                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="text-success" title="Remove Proposal From Featured Listing."
                                            href="index?remove_feature_proposal=<?= $proposal_id; ?>&page=<?= $page; ?>" />
                                        <i class="fa fa-star-half-o"></i>
                                        </a>
                                        <?php }else{ ?>
                                        <a href="index?feature_proposal=<?= $proposal_id; ?>&page=<?= $page; ?>"
                                            title="Make Your Proposal Featured">
                                            <i class="fa fa-star"></i>
                                        </a>
                                        <?php } ?>
                                        <?php if($proposal_toprated == 0){ ?>
                                        <a href="index?toprated_proposal=<?= $proposal_id; ?>&page=<?= $page; ?>"
                                            title="Make Your Proposal Top Rated">
                                            <i class="fa fa-heart" aria-hidden="true"></i>
                                        </a>
                                        <?php }else{ ?>
                                        <a class="text-danger"
                                            href="index?removetoprated_proposal=<?= $proposal_id; ?>&page=<?= $page; ?>"
                                            title="Remove Proposal From Top Rated Listing.">
                                            <i class="fa fa-heartbeat" aria-hidden="true"></i>
                                        </a>
                                        <?php } ?>
                                        <a title="Pause/Deactivate Proposal"
                                            href="index?pause_proposal=<?= $proposal_id; ?>&page=<?= $page; ?>">
                                            <i class="fa fa-pause-circle"></i>
                                        </a>
                                        <a title="Delete Proposal"
                                            href="index?move_to_trash=<?= $proposal_id; ?>&page=<?= $page; ?>">
                                    ...
                                    <td>
                                        ...
                                        <a title="Decline this Proposal"
                                            href="index?decline_proposal=<?= $proposal_id; ?>&page=<?= $page; ?>">
