                    ...
                    <div class="float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                <li class="active"> <a href="index?insert_seller_language" class="btn btn-success"> <i
                                            class="fa fa-plus-circle"></i> Add Language</a></li>
                            </ol>
                        </div>
                    </div>
                    <h4 class="h4">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="index?delete_seller_language=<?= $language_id; ?>"
                                            onclick="return confirm('You are about to delete this language perminently. Proceed?');"
