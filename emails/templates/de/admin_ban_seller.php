  ...
  <tbody>
    <tr>
      <td class="o_bg-light o_px-xs" align="center"
        style="background-color: #E8F2E8;padding-left: 8px;padding-right: 8px;">
            ...
            <tr>
              <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center"
                  ...
                  <tbody>
                    <tr>
                      <td class="o_sans o_text o_text-secondary o_b-primary o_px o_py o_br-max" align="center"
                        style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;color: <?=$site_color;?>;;border: 2px solid <?=$site_border_color;?>;;border-radius: 96px;padding-left: 16px;padding-right: 16px;padding-top: 16px;padding-bottom: 16px;">
                        <img src="<?= img_url("feedback.png"); ?>" width="48" height="48" alt=""
                ...
                <h4 class="o_heading o_text-dark o_mb-xs"
                  ...
                  Hallo, <?= $data['user_name']; ?></h4>
                <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px;">Wir müssen dir mitteilen, dass dein
                  Benutzerkonto auf <?= $site_name; ?> gebannt wurde.</p>
                <table align="center" cellspacing="0" cellpadding="0" border="0" role="presentation">
                  <tbody>
                    <tr>
                      <td width="300" class="o_btn o_bg-success o_br o_heading o_text" align="center"
                        style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;mso-padding-alt: 12px 24px;background-color: <?=$site_color;?>;border-radius: 4px;">
                        <a class="o_text-white" href="<?= $site_url; ?>/customer_support"
                          style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;">Kundendienst</a>
                      </td>
                    </tr>
                  </tbody>
                </table>
