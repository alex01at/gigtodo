...
<footer class="footer" style="background-color: <?= $footer_color ?>;">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-9"><!--- col-md-8 Starts --->
				...
				<div class="row"><!--- row Starts --->
					...
					<div class="col-md-3 col-12">
						<h3 data-toggle="collapse" data-target="#collapsecategories"><?= $lang['legal']; ?></h3>
						<ul class="collapse show list-unstyled" id="collapsecategories">
						<?php
						$get_footer_links = $db->query("select * from footer_links where link_section='legal' AND language_id='$siteLanguage'");
						while($row_footer_links = $get_footer_links->fetch()){
						$link_id = $row_footer_links->link_id;
						$link_title = $row_footer_links->link_title;
						$link_url = $row_footer_links->link_url;
			...
			<div class="col-md-3 col-12"><!--- col-md-4 Starts --->
